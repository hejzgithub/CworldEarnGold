			...
			<div class="unit login pull-right ">
				<ul class="inline clearfix">
						...
						<li style="border-right: 1px solid #e4e4e4" id="span1">
							...
							<dl>
								<a href="http://localhost:8080/CWorldEarnGold/download"><img class="download_client" src="aboutus-introduce_files/gw-03.png" alt="">下载客户端</a>
							</dl>
						</li>
		...
		<div class="float_size">
			...
			<div class="float_codes">
				<div class="img_container">
					<img src="aboutus-introduce_files/float_code.png">
...
<!--[if gt IE 8]><![endif]-->
		<ul class="about_banner" id="abnner">
			<a href="http://localhost:8080/CWorldEarnGold/about/introduce"><li class="active">黄金钱包介绍</li></a>
			...
			<div class="about_content">
				...
				<div class="about_us_text">
					<p>黄金钱包是由北京盈衍网络科技有限公司开发的解决黄金流动性的互联网产品。“黄金钱包”包括网站端（www.g-banker.com）
及app端，开展面向普通用户的买金、卖金、存金、提金、黄金生息业务，价格实时直通上海黄金交易所，最低买入或卖出的单位为1毫克（千分之一克）。</p>
					<p>由于门槛极低、界面友好、操作便捷、及时性强，极大的拉近了普通消费者和投资者与黄金的距离，使用户的资产日日生息。并获得软银中国资本（全球最大VC投资机构、阿里巴巴、淘宝、分众传媒的主要投资方）A轮投资。</p>
					<p>目前黄金钱包正努力拓展线下的存金与提金业务，将传统的以旧换新业务以“互联网+”的方式进行重构，希望能够最大程度的盘活存量黄金的流动性，并同时兼容黄金的消费属性与金融属性，努力成为用户身边的黄金增值管理专家。</p>
				</div>
			</div>
		</div>
