...
<link rel="shortcut icon" href="localhost:8080/CWorldEarnGold/statics/images/favicon.ico">
...
<body>
	<div class="regdoc row">
		<div class="title">黄金钱包网站（www.g-banker.com）服务协议</div>
		<p>最后更新时间：2014年6月12日</p>
...
若您不同意修改后的协议内容，您应停止使用本网站的服务。</p>
		...
		<div class="title2">三、现货黄金交易及管理费用</div>
		<p>3.1
...
中，此次操作将不被视为是一次购买请求。</p>
		<div class="title2">四、实物黄金购买与兑换</div>
		<p>4.1
			本网站所销售的实物黄金产品，可接受您的直接购买，也可使用在本网站购买的现货黄金进行兑换或交割；本网站有权根据实物黄金产品库存及订单情况，规定在特定时间实物黄金产品的出售或可交割、兑换限额；</p>
		<p>4.2
			当您在本网站所购买的现货黄金重量小于本网站所销售的实物黄金产品重量时，您无法在本网站完成将现货黄金交割，并兑换为实物黄金产品的操作；但您可以通过申请交割或兑换操作，并按当时金价支付差额现货黄金的售价与管理费用，以完成交割和兑换实物黄金产品的操作。</p>
...
容有任何疑问，您可通过本网站的相关系统板块查阅有关合同并进行核对。如对此有任何争议，应以本网站记录的合同为准。</p>
		<div class="title2">七、用户信息及隐私权保护</div>
...
订造的交易体验。</p>
		...
		<div class="title2">八、不保证及使用限制</div>
		<p>8.1 不保证</p>
		<p>8.1.1
...
本网站包含的资料等任何内容镜像到任何其他网站或者服务器。任何未经授权对网站内容的使用均属于违法行为，本网站将追究您的法律责任。</p>
		...
		<div class="title2">九、协议终止及账户的暂停、注销或终止</div>
		<p>9.1
...
户相关的款项。</p>
		<p>9.4本网站有权基于单方独立判断，在认为可能发生危害交易安全等情形时，不经通知而先行暂停、中断或终止向您提供本协议项下的全部或部分会员服务，并将注册资料移除或删除，且无需对您或任何第三方承担任何责任。前述情形包括但不限于：</p>
...
有资金的请求，经核验属实后，本网站可配合您将原有资金转移到以您真实姓名登记的银行账户下。</p>
		<div class="title2">十、通知</div>
		<p>本协议项下的通知如以公示方式作出，一经在本网站公示即视为已经送达。除此之外，其他向您个人发布的具有专属性的通知将由本网站向您在注册时提
供的电子邮箱，或本网站在您的个人账户中为您设置的站内消息系统栏，或您在注册后在本网站绑定的手机发送，一经发送即视为已经送达。请您密切关注您的电子
邮箱
...
未收到或未阅读该等通知信息主张相关通知未送达于您。</p>
		...
		<p>订单支付时间：本网站所定义的“订单支付时间”，是指本网站为用户成功进行订单支付所预留的时间限定；从用户提交购买需求（包括现货黄金或实物
黄金的购买需求）的订单确认与生成，到用户成功完成支付操作的时间，不应超过“订单支付时间”；否则，本网站将认为订单失效并作废。如果用户超出“订单支
付时间”而支付成功的，由于订单本身已失效，本网站将不认为该支付是用户的订单支付，而将被认为是一次充值操作，并将用户支付的金额充入用户在本网站的现
金账户中。</p>
	</div>
