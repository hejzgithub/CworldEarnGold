	...
	<div class="row">
		...
		<div class="nav unit">
			<ul class="inline">
				...
				<li class="active"><a href="http://localhost:8080/CWorldEarnGold/about">关于我们</a></li>
...
<!--[if gt IE 8]><![endif]-->
		<ul class="about_banner" id="abnner">
			...
			<a href="http://localhost:8080/CWorldEarnGold/about/team"><li class="active">黄金团队</li></a>
				...
				<div class="team_content">
					<div class="team_each">
						...
						<ul class="header_intro">
							<li class="_headName">杨㟀罡&nbsp;&nbsp;&nbsp;董事长/创始人</li>
							<li class="header_infor">
								<p>毕业于北京大学光华管理学院曾任职摩根士丹利(Morgan Stanley)
									IBD部门，东方花旗证券投资银行部副总监</p>
							</li>
					...
					<div class="team_each">
						...
						<ul class="header_intro">
							<li class="_headName">张晶&nbsp;&nbsp;&nbsp;CEO/联合创始人</li>
							<li class="header_infor">
								<p>
									毕业于北京大学光华管理学院，曾任韬睿惠悦(Towers Watson)咨询顾问<br>Kissrice.com CEO
								</p>
							</li>
					...
					<div class="team_each">
						...
						<ul class="header_intro">
							<li class="_headName">罗茜&nbsp;&nbsp;&nbsp;联合创始人/投资顾问</li>
							<li class="header_infor">
					...
					<div class="team_each">
						...
						<ul class="header_intro">
							<li class="_headName">于杰&nbsp;&nbsp;&nbsp;联合创始人/风控顾问</li>
							<li class="header_infor">
					...
					<div class="team_each">
						<ul class="team_intro">
							<li class="_head"><div class="about_intro_icon"></div> <span>产品技术团队</span></li>
							<li class="team_infor">
								<p>产品技术团队来自百度、豌豆荚、阿里巴巴、高德及酷我音乐等知名互联网公司，确保黄金钱包在线上系统的安全性、稳定性及流畅性。</p>
							</li>
						</ul>
					</div>
					<div class="team_each">
						<ul class="team_intro">
							<li class="_head"><div class="about_intro_icon"></div> <span>市场运营团队</span></li>
							<li class="team_infor">
								<p>团队成员主要来自于奥美（Ogilvy&amp;Mather）、百度、腾讯、阿里巴巴、百胜餐饮（Yum!Brands）等企业，拥有丰富的市场品牌及产品运营经验，深入了解客户、了解市场</p>
							</li>
						</ul>
					</div>
					<div class="team_each" style="border: 0px;">
						<ul class="team_intro">
							<li class="_head"><div class="about_intro_icon"></div> <span>风控团队</span></li>
							<li class="team_infor">
								<p>来自于摩根士丹利香港及普华永道等国际金融机构，严格审核借金企业资质，从根源上保证每一位用户的黄金资产安全。</p>
							</li>
						</ul>
					</div>
				</div>
